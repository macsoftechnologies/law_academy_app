...
import { PRELIMS_SECTIONS_LIST } from '../../../data/mock/prelims.mock';
  ...
  return (
    <SafeAreaView style={s.safe} edges={['top']}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={s.scroll}>
        ...
        {/* Section cards */}
        {PRELIMS_SECTIONS_LIST.map(item => (
...
const s = StyleSheet.create({
  ...
  cardTitle: { fontSize: 16, fontWeight: '800', color: C.textDark, marginBottom: 10 },
